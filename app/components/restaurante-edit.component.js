...
var RestauranteEditComponent = (function () {
    ...
    RestauranteEditComponent.prototype.ngOnInit = function () {
        ...
        this.restaurante = new Restaurante_1.Restaurante(this._routeParams.get("id"), this._routeParams.get("nombre"), this._routeParams.get("direccion"), this._routeParams.get("descripcion"), this._routeParams.get("imagen"), this._routeParams.get("precio"));
        this.getRestaurante();
    };
